...
public class ProductController {
  ...
  public String findByPId(@PathVariable("id") Long pid,
                                Model model) {
  ...
  //수정양식
  @GetMapping("/{id}/edit")
  public String updateForm(@PathVariable("id") Long pid,
                           Model model) {
  ...
  //수정
  @PostMapping("/{id}/edit")
  public String update(@PathVariable("id") Long pid,
